...
beamComponents(firstModel,'line1', startCoord, endCoord,nEvaluationPoints, integrationWidth = 0, nIntegrationPoints=30)

plotBeamComponent(firstModel,'line1', verticalDisplacement = False, bendingMomentsToPlot = ['x','y'], shearForcesToPlot = ['x','y'], plotOnMesh = False)
